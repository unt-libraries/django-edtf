...
class TestURLs(SimpleTestCase):
    ...
    def test_results_json_url_with_query(self):
        pass
...
class TestUrlErrorView(SimpleTestCase):

    pass


#lass ViewsTest(SimpleTestCase):
#   """
#   This test class makes sure views get called and return proper response code
#   """

#   def test_json(self):
#       """test json view and responses"""
#       # issue get request to test
#       good_response = self.client.get('/edtf/isValid.json?date=3113')
#       not_found_response = self.client.get('/edtf/isValid.jso?date=3113')
#       bad_response = self.client.get('/edtf/isValid.json?year=3113')
...
#       # issue get request to test
#       good_response = self.client.get('/edtf/isValid.json?date=2000')
#       bad_response = self.client.get('/edtf/isVald.json?dat=2000')
#       # check that the response is 200 OK.
#       self.assertEqual(good_response.status_code, 200)
...
#       # issue get request to test
#       response = self.client.get('/edtf/')
#       # check that the response is 200 OK.
#       self.assertEqual(response.status_code, 200)


#lass DatesTest(SimpleTestCase):
